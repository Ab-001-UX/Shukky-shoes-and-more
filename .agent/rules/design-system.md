...
- `tokens/theme.css` — all color values, all font sizes, weights, line heights, and font families
...
Shukkyshoes and More users are primarily on mobile. Every component must be built mobile-first:
...
- The checkout page (`/checkout`) must be fully functional on a 375px viewport.